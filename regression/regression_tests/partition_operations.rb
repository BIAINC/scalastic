module RegressionTests
  module PartitionOperations
    ...
    def run
      ...
      RegressionTests.prepare_index "integer", 'partition_operations'
      partition1 = partitions.create(index: 'partition_operations', id: 1)
      partition2 = partitions.create(index: 'partition_operations', id: 2)

      partition1.index id: 1, type: 'test', body: {subject: 'Subject 1'}
      partition1.index id: 2, type: 'test', body: {subject: 'Subject 2'}
      ...
      hits = partition1.search(type: 'test', body: {query:{match_all: {}}})['hits']['hits']
      ...
      partition1.delete type: 'test', id: 1
